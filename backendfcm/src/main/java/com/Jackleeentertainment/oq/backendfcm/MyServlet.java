...
package com.jackleeentertainment.oq.backendfcm;
...
public class MyServlet extends HttpServlet {
     ...
     static Logger Log = Logger.getLogger("com.jackleeentertainment.oq.backendfcm.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream
                        ("/WEB-INF/OQMoney-632dd257f823.json"))
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("reminder@oqmoney-93ff2.appspotmail.com",
                            "Todo Reminder"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("tianxia8@naver.com", "Recipient"));
