...
public class ProfileArlCheckableRVAdapter extends RecyclerView.Adapter<AvatarNameEmailChkViewHolder> {
    String TAG = "ProfileArlCheckableRVAdapter";

    ArrayList<Profile> arlProfilesAll;
    ArrayList<Profile> arlProfileSelected;
    Fragment mFragment;

    public ProfileArlCheckableRVAdapter() {
        super();
    }

    public ProfileArlCheckableRVAdapter(Fragment _mFragment) {
        super();
        mFragment = _mFragment;
    }

    public ProfileArlCheckableRVAdapter(Fragment _mFragment, ArrayList<Profile> _arlProfiles) {
        super();
        mFragment = _mFragment;
