//package com.jackleeentertainment.oq.ui.layout.fragment.util;
//
...
//
//    void initAdapter() {
//        selectedPeopleListAdapter = new NewGroupFrag.SelectedPeopleListAdapter(getActivity());
//    }
//
//
//
...
//            NewGroupFrag.SelectedPeopleListAdapter.ProfileViewHolder holder;
//
//            //check to see if the reused view is null or not, if is not null then reuse it
//            if (convertView == null) {
//                holder = new NewGroupFrag.SelectedPeopleListAdapter.ProfileViewHolder();
...
//                holder = (NewGroupFrag.SelectedPeopleListAdapter.ProfileViewHolder) convertView.getTag();
//            }
//
